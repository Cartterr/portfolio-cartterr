      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <div
              className="relative w-full h-96 bg-primary-secondary rounded-3xl flex items-center justify-center overflow-hidden glass-effect"
            ...
            >
                        ...
                        {images.map((img, idx) => {
                          ...
                          return (
                            <img
                              ...
                              src={img.url}
                              alt={img.name}
                              className="absolute top-0 left-0 h-full w-full object-cover transition-all duration-700 will-change-transform"
                              style={{
              ...
              {images.length > 0 && (
                <button onClick={() => openLightbox(currentSlide)} className="absolute inset-0" aria-label="Open gallery" />
              )}
            </div>
          </motion.div>
