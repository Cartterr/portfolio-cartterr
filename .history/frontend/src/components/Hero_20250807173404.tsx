...
const Hero = () => {
  ...
  const gridSvg = encodeURIComponent('<svg width="60" height="60" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><g fill="none" fill-rule="evenodd"><g fill="#ffffff" fill-opacity="0.02"><circle cx="30" cy="30" r="1"/></g></g></svg>')
