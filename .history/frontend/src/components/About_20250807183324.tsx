                        ...
                        {images.map((img, idx) => {
                          ...
                          return (
                            <img
                              ...
                              src={img.url}
                              alt={img.name}
                              className={`absolute top-0 left-0 h-full w-full object-cover ${isActive ? 'kenburns' : ''}`}
                              style={{
                                opacity: isActive ? 1 : 0,
                                transform: isActive ? 'translate3d(0,0,0)' : isPrev ? 'translate3d(-16px,0,0)' : 'translate3d(0,0,0)',
