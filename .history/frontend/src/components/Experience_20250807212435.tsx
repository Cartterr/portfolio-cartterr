...
const Experience = () => {
  const experiences = [
    ...
    },
    {
      ...
      description: (
        <>
          Distinguished "Advanced Level Teaching Assistant". Taught at Escuela de Ingeniería and also served as <strong>Ayudante</strong> at Escuela Militar. Courses: Sistemas Operativos y Redes (IIC2333), Testing de Software (IIC3745), Computación de Alto Rendimiento (IIC3533), e IIC1005 Computación: Ciencia y Tecnología del Mundo Digital. Additionally supported introductory programming courses.
        </>
      ),
