  ...
  const Gallery: React.FC<{ images: { name: string; url: string }[] }> = ({ images }) => {
    ...
    return (
      ...
      >
        ...
        {activeIdx !== null && (
          <div className="fixed inset-0 z-[90] flex items-center justify-center bg-black/80" onClick={() => setActiveIdx(null)}>
            <div className="relative max-w-6xl w-[96vw]" onClick={(e) => e.stopPropagation()}>
