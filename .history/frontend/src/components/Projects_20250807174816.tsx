        ...
        <div className="grid md:grid-cols-2 gap-8">
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="pointer-events-none absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300" style={{ background: 'radial-gradient(600px circle at var(--x,50%) var(--y,50%), rgba(0,212,255,0.08), transparent 40%)' }} />
            </motion.div>
          ))}
        </div>
      </div>
