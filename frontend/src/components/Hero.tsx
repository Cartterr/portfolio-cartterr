  ...
  return (
    ...
    >
      <div className="absolute inset-0 opacity-20">
        <div className="absolute inset-0 bg-[url('data:image/svg+xml,<svg width=\"60\" height=\"60\" viewBox=\"0 0 60 60\" xmlns=\"http://www.w3.org/2000/svg\"><g fill=\"none\" fill-rule=\"evenodd\"><g fill=\"%23ffffff\" fill-opacity=\"0.02\"><circle cx=\"30\" cy=\"30\" r=\"1\"/></g></svg>')] floating-animation"></div>
      </div>
      ...
      <div className="text-center z-10 max-w-5xl mx-auto px-6">
        ...
        <motion.p
          ...
          className="text-lg sm:text-xl md:text-2xl text-gray-400 mb-12 max-w-4xl mx-auto"
        >
          Software Engineer | Full-Stack Developer | AI & Data Science Researcher
        </motion.p>
