import type { GalleryKey } from './imageManifest'
...
export const experienceEntries: ExperienceEntry[] = [
  {
    ...
    summary: 'Implemented mission-planning logic for autonomous drone coordination, combining routing algorithms, MQTT messaging, and OpenAI-assisted decision support in a U.S. research setting.',
    impact: 'This was NASA and NSF backed work focused on emergency-response planning under operational constraints, and it remains one of the clearest signals of the aerospace and autonomy direction I want to keep building toward.',
    stack: ['Python', 'Algorithms', 'MQTT', 'OpenAI API', 'Angular', 'Java Spring'],
    gallery: 'nd' as const,
    link: { href: 'https://droneresponse.ai/', label: 'Drone Response project' },
  },
  {
